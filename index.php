                                ...
                                <div class="col-xl-11">
                                    <div class="ms-banner__main-wrapper">
                                                ...
                                                <div class="ms-banner__form-select ms-nice-select">
                                                    ...
                                                    <div class="ms-banner__form-select ms-nice-select ms-border-none">
                                                        <select>
                                                            ...
                                                            <option value="3">In a Home</option>
                                                    ...
                                                    <div class="banner__form-button">
                                                         ...
                                                         <a href="contact.php">Book Band</a></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="col-12 pt-50">
                                            <h3 class="text-center text-light">The Nobles Epitomize Versatility, Effortlessly Traversing Through A Myriad Of Musical Genres Including Pop, Rock, Funk, Blues, Country, And Dance As Well As Delivering A Totally Electrifying Performances. Comprising Seasoned Virtuosos In Their Respective Instrument, Each Member Brings A Wealth Of Experience Garnered From Years Of Touring, Performing, And Recording At The Highest Levels In The Industry. Embark On A Journey Of Unparalleled Musical Excellence; Join Us And Immerse Yourself In An Unforgettable Experience Filled With Boundless Fun, Dancing And Euphoric Rhythms.</h3>
                                        </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="work__area work-overlay pt-125 pb-60 include__bg" data-background="assets/img/bg/bg.webp ">
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center justify-content-center bdFadeUp">
                        ...
                        <div class="col-xl-4 lg-4 md-12 justify-content-center">
                                ...
                                <div class="work__features-inner">
                                    <div class="work__features-item">
                                        <div class="work__features-content">
                                            <h4>Bob Noble</h4>
                                            <p>Lead Guitarist, Musical Director, Vocalist. Well Known In The Central Pa Area As One Of The Best, If Not "THE BEST" Lead Guitarists In The Area. Brings Expert Musicality, Guitar Olympics And Vocals To A Great Band.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="work__content-wrapper work__content-space mb-70 pl-40">
                                <div class="work__features-inner">
                                    <div class="work__features-item">
                                        <div class="work__features-content">
                                            <h4>Zoey Noble</h4>
                                            <p>Bass Guitar, Lead Vocals. Well Known Since She Was A Child. Became An Extremely Accomplished Bass Player And Vocalist With Direction And Encouragement From Her Dad. Currently, Studying Music As A Major In College. Working Towards A Successful Solo Career.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="work__features-inner">
                                    <div class="work__features-item">
                                        <div class="work__features-content">
                                            ...
                                            <p>Well Known Studio Drummer For Mercury Records, Signed By Steve Katz Of BST And Working For Years With National Acts In Studio And On US National Tours. Thrilled To Be Part Of This Premium Act.
                                            </p>
                                        </div>
                                    ...
                                    <div class="work__features-bottom">
                                        <div class="work__features-action">
                                            <div class="work__features-btn">
                                                <a class="unfill__btn" href="contact.php">Book Band</a>
                                            </div>
                    ...
                    <div class="row align-items-end mb-25 bdFadeUp">
                        <div class="col-lg-8">
                            <div class="section__title-wrapper mb-40 bd-title-anim">
                                ...
                                <div id="msg-title">
                                    <h2 class="section__title"><span class="">Some Popular
                                            Venues</span>
                                    </h2>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="trending-btn mb-40 d-flex justify-content-lg-end">
                                <a class="border__btn" href="contact.php">Book Band</a>
                            </div>
                        </div>
                    </div>
                    <div class="row bdFadeUp">
                            ...
                            <div class="trending-item">
                                ...
                                <div class="trending__info">
                                    ...
                                    <div class="trending__content">
                                        <h4><a href="contact.php">Party bands for hire</a></h4>
                            ...
                            <div class="col-xl-5">
                                <div class="ms-tm-img-wrap ms-tm-space p-relative mb-60">
                                    <div class="ms-tm-img-main p-relative m-img">
                                        ...
                                        <img src="assets/img/about/aboutpic-1.webp" alt="testimonial image">
                                    </div>
                                        ...
                                        <div class="ms-tm-active">
                                            <div class="ms-tm-slick">
                                                <div class="ms-tm-slick-item">
                                                    <p>Very Nice Band. Dad and Daughter are very Generrous! Very Professional and their Events are always Filled with Greate Vibes!</p>
                                                    <div class="ms-tm-author">
                                                        <h4 class="ms-tm-author-title">Diana Santiago</h4>
                                                        <span class="ms-tm-author-subtitle">Via Facebook Jul 23</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="ms-tm-slick">
                                                <div class="ms-tm-slick-item">
                                                    <p>I am Talking about Good Vibrations. <br>Great Sound, you can Feel that They Love the are Doing</p>
                                                    <div class="ms-tm-author">
                                                        <h4 class="ms-tm-author-title">Donald Himes</h4>
                                                        <span class="ms-tm-author-subtitle">Via Facebook Oct 23</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="ms-tm-slick">
